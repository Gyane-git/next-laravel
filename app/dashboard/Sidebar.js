          ...
          {categories.map((category) => (
            <div key={category.id} className="relative px-2">
              <div
                ...
                onMouseEnter={() => {
                  setHoveredCategory(
                    category.subcategories ? category.id : null
                  );
              ...
              {hoveredCategory === category.id && category.subcategories && (
                <div
                  className="absolute top-0 left-[calc(50%+1.5rem)] z-50 w-64 bg-white border border-gray-200 rounded-xl shadow-xl"
                  ...
                  <div className="py-2">
                    {category.subcategories.map((subcategory) => (
                      <div key={subcategory.id}>
                        ...
                        >
                          <span className="font-medium text-gray-600 group-hover:text-green-700 text-sm">
                            {subcategory.name}
                          </span>
                          {subcategory.subSubcategories && (
                                ...
                                {subcategory.subSubcategories.map(
                                  (item, index) => (
                                    <div
                                      ...
                                      onClick={() =>
                                        handleClick(item, "subsubcategory")
                                      }
                                    >
                                      <span className="text-xs font-medium text-gray-600 hover:text-purple-700">
                                        {item}
                                      </span>
                                    </div>
                                  )
